    ...
    <tbody>
      {currentRows.map((item, idx) => (
        <tr key={idx}>
          ...
          <td data-label="Student" className="student-info">
            <img
              src={
          ...
          <td data-label="Overall Score">{item.totalMarkScored}/300</td>
          ...
          <td data-label="Accuracy">{Number(item.accuracy).toFixed(2)}%</td>
        </tr>
      ))}
    </tbody>
  );
